...
export default function SudokuGame() {
  ...
  return (
    <div className="flex flex-col gap-2 md:gap-4">
      {!gameState ? (
        <div className="flex flex-col gap-3 p-4 md:p-6 rounded-xl bg-white shadow-xl">
          <h2 className="text-xl md:text-2xl font-bold text-purple-800">Game Settings</h2>
          <div className="flex flex-col gap-2">
            <label htmlFor="difficulty" className="text-sm font-medium text-purple-700">
              Difficulty
            </label>
            <Select value={difficulty} onValueChange={(value) => setDifficulty(value as "easy" | "medium" | "hard")}>
              <SelectTrigger id="difficulty" className="bg-white border-purple-300 text-purple-800">
                <SelectValue placeholder="Select difficulty" />
              </SelectTrigger>
              <SelectContent className="bg-white border-purple-300">
                <SelectItem value="easy" className="text-purple-800 focus:bg-purple-100">
                  Easy
                </SelectItem>
                <SelectItem value="medium" className="text-purple-800 focus:bg-purple-100">
                  Medium
                </SelectItem>
                <SelectItem value="hard" className="text-purple-800 focus:bg-purple-100">
                  Hard
                </SelectItem>
              </SelectContent>
            </Select>
          ...
          <Button
            ...
            className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-bold shadow-lg hover:shadow-xl transition-all mt-2"
          >
            START GAME
          </Button>
        </div>
        ...
        <>
          <div className="flex justify-between items-center mb-2 md:mb-4 p-3 md:p-4 bg-white/90 rounded-xl shadow-lg">
            <div className="text-base md:text-xl font-bold text-purple-900">
              <span className="text-cyan-700">YOU:</span> {gameState.players[0].score}
            </div>
            <div className="text-base md:text-xl font-bold text-purple-900">
              <span className="text-fuchsia-700">CPU:</span> {gameState.players[1].score}
            </div>
          </div>

          <div className="p-3 bg-white/90 rounded-xl mb-3 border-l-4 border-fuchsia-500 shadow-lg">
            <p className="text-xs md:text-sm text-purple-900 font-medium">{gameState.message}</p>
          </div>
          ...
          <div className="mt-4 md:mt-6">
            <h3 className="text-sm md:text-lg font-bold mb-2 md:mb-3 text-white bg-purple-700/80 px-3 py-1 rounded-lg inline-block">
              YOUR HAND
            </h3>
            <PlayerHand
          ...
          <div className="mt-3 md:mt-4 flex justify-between text-xs md:text-sm">
            <div className="bg-white/90 text-purple-900 font-bold px-3 py-1 rounded-full">
          ...
          {gameState.gameOver && (
            <Button
              onClick={startNewGame}
              className="mt-4 md:mt-6 bg-gradient-to-r from-fuchsia-600 to-pink-600 hover:from-fuchsia-700 hover:to-pink-700 text-white font-bold shadow-lg hover:shadow-xl transition-all"
            >
              PLAY AGAIN
            </Button>
          )}
